...
public class AdaptadorCalibragem extends RecyclerView.Adapter<com.example.forestsys.AdaptadorCalibragem.CalibragemHolder>{
    ...
    @NonNull
    @Override
    public com.example.forestsys.AdaptadorCalibragem.CalibragemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_lista_calibragem, parent, false);

        return new com.example.forestsys.AdaptadorCalibragem.CalibragemHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.forestsys.AdaptadorCalibragem.CalibragemHolder holder, int position) {
        ...
        holder.p1Desvio.setText(String.valueOf(calibragem.getP1_DESVIO()));
        holder.p2Desvio.setText(String.valueOf(calibragem.getP2_DESVIO()));
    }
