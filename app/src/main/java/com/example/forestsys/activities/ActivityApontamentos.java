        ...
        botaoProsseguir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (oSAtividadesDiaAtual == null) {
                    Intent it = new Intent(ActivityApontamentos.this, ActivityMain.class);
                    startActivity(it);
                }
                ...
                if (oSAtividadesDiaAtual != null) {
                    if (oSAtividadesDiaAtual.getID_PROGRAMACAO_ATIVIDADE() != null && !oSAtividadesDiaAtual.getDATA().trim().isEmpty() &&
                            ...
                            !oSAtividadesDiaAtual.getHO_ESCAVADEIRA().toString().trim().isEmpty() && !oSAtividadesDiaAtual.getHO().toString().trim().isEmpty() &&
                            !oSAtividadesDiaAtual.getHM_ESCAVADEIRA().toString().trim().isEmpty() && !oSAtividadesDiaAtual.getHM().toString().trim().isEmpty() &&
                            !oSAtividadesDiaAtual.getHH().toString().trim().isEmpty() && oSAtividadesDiaAtual.getAREA_REALIZADA() != null) {
